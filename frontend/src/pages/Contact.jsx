                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">support@locallink.com</p>
                      <p className="text-sm text-muted-foreground">info@locallink.com</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <div className="lg:col-span-2">
              <Card>
                <CardContent className="p-8">
                  ...
                  <form className="space-y-6" onSubmit={submitContactForm}>
